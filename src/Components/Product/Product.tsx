        ...
        ({
          ...
          >
            <div className="w-full h-[260px] relative">
              ...
              {isNew && (
                <p className="absolute top-0 left-0 text-amazon_blue font-medium text-xs tracking-wide animate-bounce">
            ...
            <div className="px-4 py-3 flex flex-col gap-1">
              <p className="text-xs text-gray-500 tracki">{category}</p>
